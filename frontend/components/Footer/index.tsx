...
const footer = () => {
    return (
        <div className="bg-black -mt-40" id="first-section">
            ...
            {/* online_auction_backend Reserved */}

            <div className="mx-auto max-w-2xl lg:max-w-7xl">
                <div className="pt-5 pb-5 px-4 sm:px-6 lg:px-4 border-solid border-t border-footer">
                    <div className="mt-4 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 xl:gap-x-8">
                        <div>
                            <h3 className='text-center md:text-start text-offwhite text-lg'>@2025 - CSC309 Week 12 All Rights Reserved by <Link href="https://fxxfermi.com/" target="_blank"> fxxfermi.com</Link></h3>
                        </div>
